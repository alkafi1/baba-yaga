...
<body>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right ai-icon"> 
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('assign.role.user') }}">Assign Role To User</a></li>
                            <li><a href="{{ route('add.role.permission') }}">Add Role And permission</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('product') }}">Prtoduct List</a></li>
                            <li><a href="{{ route('addproduct') }}">Add Product</a></li>
                            {{--  <li><a href="{{ route('product_inventory') }}">Inventory</a></li>  --}}
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Copupn</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('add.coupon') }}">Add Copuon</a></li>
                        </ul>
                    </li>
    ...
    ***********************************-->
	...
	<!-- Dashboard 1 -->
	<script src="{{ asset('/backend/js/dashboard/workout-statistic.js') }}"></script>
	<!--Sweet Alert-->
