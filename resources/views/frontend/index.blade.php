                                ...
                                @foreach ($products as $product )
                                    <div class="grid">
                                        <div class="product-pic">
                                            <a href="{{ route('product_details',$product->slug) }}"><img src="{{ asset('upload/product') }}/{{ $product->product_image }}" alt></a>
                                            @if($product->discount != '')
                                        ...
                                        <div class="details">
                                            ...
                                            <span class="price">
                                                ...
                                                <del>
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol">BDT </span>{{ $product->price }}
                                                        </bdi>
                                                    </span>
                                                </del>
                                                @endif
                        ...
                        <div class="product-sidebar">
                            <div class="widget latest_product_carousel">
                                ...
                                <div class="vertical_slider_4item" data-slick='{"dots": false}'>
                                    <div class="slider_item">
                                        <div class="small_product_layout">
                                            <a class="item_image" href="shop_details.html">
                                                <img src="{{ ('frontend/assets/images/latest_product/latest_product_1.png') }}" alt="image_not_found">
                                            </a>
                                            <div class="item_content">
                                                <h3 class="item_title">
                                    ...
                                    <div class="slider_item">
                                        <div class="small_product_layout">
                                            <a class="item_image" href="shop_details.html">
                                                <img src="{{ ('frontend/assets/images/latest_product/latest_product_2.png') }}" alt="image_not_found">
                                            </a>
                                            <div class="item_content">
                                                <h3 class="item_title">
                                                    <a href="shop_details.html">Product Sample</a>
                                    ...
                                    <div class="slider_item">
                                        <div class="small_product_layout">
                                            <a class="item_image" href="shop_details.html">
                                                <img src="{{ ('frontend/assets/images/latest_product/latest_product_3.png') }}" alt="image_not_found">
                                            </a>
                                            <div class="item_content">
                                                <h3 class="item_title">
                                                    <a href="shop_details.html">Product Sample</a>
                                    ...
                                    <div class="slider_item">
                                        <div class="small_product_layout">
                                            <a class="item_image" href="shop_details.html">
                                                <img src="{{ ('frontend/assets/images/latest_product/latest_product_4.png')}}" alt="image_not_found">
                                            </a>
                                            <div class="item_content">
                                                <h3 class="item_title">
                                                    <a href="shop_details.html">Product Sample</a>
                            ...
                            <div class="widget product-add">
                                <div class="product-img">
                                    <img src="{{ ('frontend/assets/images/shop/product_img_10.png') }}" alt>
                                </div>
                                <div class="details">
                                    <h4>iPad pro</h4>
                    ...
                    <div class="col col-lg-7">
                        <div class="new-arrivals-grids clearfix">
                            @foreach ($new_arrivals as $new_arrival )
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('upload/product') }}/{{ $new_arrival->product_image }}" alt>
                                        <div class="actions">
                                            <ul>
                                                <li>
                                                    <a href="#"><svg role="img" xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" viewBox="0 0 24 24" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Favourite</title> <path d="M12,21 L10.55,19.7051771 C5.4,15.1242507 2,12.1029973 2,8.39509537 C2,5.37384196 4.42,3 7.5,3 C9.24,3 10.91,3.79455041 12,5.05013624 C13.09,3.79455041 14.76,3 16.5,3 C19.58,3 22,5.37384196 22,8.39509537 C22,12.1029973 18.6,15.1242507 13.45,19.7149864 L12,21 Z"/> </svg></a>
                                    ...
                                    <div class="details">
                                        <h4><a href="#">{{ $new_arrival->product_name }}</a></h4>
                                        <p><a href="#">{{ $new_arrival->short_desp }}</a></p>
                                        <span class="price">
                                                <ins>
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol">BDT </span>{{ $new_arrival->after_discount }}
                                                        </bdi>
                                                    </span>
                                                </ins>
                                                @if($new_arrival->discount != null)
                                                <del>
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol">BDT </span>{{ $new_arrival->price }}
                                                        </bdi>
                                                    </span>
                                                </del>
                                                @endif
