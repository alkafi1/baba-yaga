                ...
                <aside class="sidebar_section p-0 mt-0">
                    ...
                    <div class="sb_widget">
                        ...
                        <div class="filter_sidebar">
                            ...
                            <div class="fs_widget">
                                <h3 class="fs_widget_title">Filterer By category</h3>
                                <form action="#">
                            ...
                            <div class="fs_widget">
                                <h3 class="fs_widget_title">Filterer By Color</h3>
                                <form action="#">
                                    <ul class="fs_brand_list ul_li_block">
                                        <li>
                                            <div class="checkbox_item">
                                                @foreach ($colors as $color )   
                                                <input id="apple_brand" type="radio" class="color_id" name="color_id" value="{{ $color->id }}"
                            ...
                            <div class="fs_widget">
                                <h3 class="fs_widget_title">Filterer By Size</h3>
                                <form action="#">
                                    <ul class="fs_brand_list ul_li_block">
                                        <li>
                                            <div class="checkbox_item">
                                                @foreach ($sizes as $size )   
                                                <input id="apple_brand" type="radio" class="size_id" name="size_id" value="{{ $size->id }}" 
                            ...
                            <div class="fs_widget">
                                <h3 class="fs_widget_title">Filterer By Price</h3>
                                ...
                                <div class="grid">
                                    ...
                                    <div class="details">
                                        ...
                                        <div class="add-cart-area">
                                            <button class="add-to-cart"><a class="text-dark" href="{{ route('product_details',$product->slug) }}"> Add to cart</a></button>
                                        </div>
                                    </div>
                                </div>
                                @empty
