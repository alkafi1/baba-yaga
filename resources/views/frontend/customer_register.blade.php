                                ...
                                <div class="tab-pane fade show active" id="signin_tab" role="tabpanel">
                                    <form action="{{ route('customer.login') }}" method="post">
                                        ...
                                        <div class="form_item_wrap">
                                            ...
                                            <div class="form_item">
                                                <label for="useremail_input"><i class="fas fa-user"></i></label>
                                                <input id="useremail_input" type="email" name="email" placeholder="User email">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form_item_wrap">
                                            ...
                                            <br>
                                            <a href="{{ route('github.redirect') }}" class="btn btn-primary">Sign in With <i class="fab fa-github"></i></a>
                                            <a href="{{ route('google.redirect') }}" class="btn btn-primary">Sign in With <i class="fab fa-google"></i></a>
                                            {{--  <a href="" class="btn btn-primary">Sign in With <i class="fab fa-facebook"></i></a>  --}}
                                        </div>
                                    </form>
                                </div>
